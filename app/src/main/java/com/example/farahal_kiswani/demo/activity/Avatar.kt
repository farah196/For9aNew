...
import de.hdodenhof.circleimageview.CircleImageView
 ...
 class Avatar(context: Context, attrs: AttributeSet?) : CoordinatorLayout.Behavior<CircleImageView>() {
    ...
    var finalXPosition:Float = 0.toFloat()
    ...
    private var finalHeight:Float = 0.toFloat()
     ...
     init {
         if (attrs != null) {
             ...
             finalXPosition = a.getDimension(R.styleable.Avatar_finalXPosition, 0f)
             finalYPosition = a.getDimension(R.styleable.Avatar_finalYPosition, 0f)
             finalHeight = a.getDimension(R.styleable.Avatar_finalHeight, 0f)
             finalToolbarHeight = a.getDimension(R.styleable.Avatar_finalToolbarHeight, 0f)
             a.recycle()
         }
     }
